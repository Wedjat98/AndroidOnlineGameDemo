...
<body>
  <div class="intro" style="margin-top:100px;">
  	 &nbsp;
    <div style="color:#F00" class="validator-tips"><b>枫之战纪-玩家自助授权</b></div>
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-8 col-centered">
          <form method="post" id="register-form" autocomplete="off" action="#" class="nice-validator n-default" novalidate>
			...
			<div class="form-group">
			  <input type="text" class="form-control" id="usr" name="usr" placeholder="角色ID" autocomplete="off">
            </div>
			<div class="form-group">
            ...
            <div id="divMsg" style="color:#F00" class="validator-tips">Gz 2020</div>
          </form>
        </div>
      </div>
    </div>
