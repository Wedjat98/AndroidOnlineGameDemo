...
<body>
  <div class="intro" style="margin-top:100px;">
    <div class="col-md-3 col-centered tac"><B>枫之战纪后台</B></div>
	&nbsp;
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-8 col-centered">
          <form method="post" id="register-form" autocomplete="off" action="#" class="nice-validator n-default" novalidate>
            ...
            <div id="divMsg" style="color:#F00" class="validator-tips">角色ID查看方法<br>点击头像-经验条下方属性页<br>向左滑动即可看到<br>部分礼包需游戏内显示出才可购买</div>
          </form>
        </div>
      </div>
    </div>
